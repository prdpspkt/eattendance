...
urlpatterns = [
    ...
    path('leave-balances/', views.leave_balance_management, name='leave_balance_management'),
    path('leave-balances/rebuild/', views.leave_balance_rebuild, name='leave_balance_rebuild'),
    path('leave-balances/me/', views.leave_entitlement_detail, name='my_leave_entitlement'),
    path('leave-balances/<int:employee_id>/', views.leave_entitlement_detail, name='leave_entitlement_detail'),
